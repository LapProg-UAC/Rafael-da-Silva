...
# 2. Testa e Sobrancelhas (TRISTE - Centro elevado, pontas caídas)
# Elevação no centro das sobrancelhas
Z += surf(-0.12, 0.48, 0.12, 0.08, 0.09) # Lado interno Esq
Z += surf(0.12, 0.48, 0.12, 0.08, 0.09)  # Lado interno Dir
# Queda nas pontas externas
Z += surf(-0.35, 0.38, 0.15, 0.07, 0.04) # Lado externo Esq
Z += surf(0.35, 0.38, 0.15, 0.07, 0.04)  # Lado externo Dir
...
# 5. Maçãs do Rosto (Mais baixas e menos volumosas)
Z += surf(-0.35, -0.15, 0.2, 0.2, 0.04)
Z += surf(0.35, -0.15, 0.2, 0.2, 0.04)

# 6. BOCA TRISTE (Cantos para baixo)
# Lábio superior central
Z += surf(0, -0.45, 0.18, 0.04, 0.05)
# Cantos da boca puxados para baixo (Depressão volumétrica)
Z -= surf(-0.22, -0.58, 0.1, 0.1, 0.08)
Z -= surf(0.22, -0.58, 0.1, 0.1, 0.08)
