...
# 1. Hashing por folding
# 2. Verificação de integridade
# 3. Keyed hash (hash com chave)
...
# -----------------------------------------------------------
# FUNÇÃO: folding_hash
# Calcula o hash de um texto usando o método folding
# -----------------------------------------------------------
...
# Verifica se o hash de um texto corresponde ao hash original
# -----------------------------------------------------------
...
# -----------------------------------------------------------
# FUNÇÃO: keyed_hash
# Cria uma assinatura adicionando uma chave secreta
# -----------------------------------------------------------
...
# -----------------------------------------------------------
# FUNÇÃO: verificar_autenticidade
...
# -----------------------------------------------------------
# FUNÇÃO: hash_ficheiro
# Calcula o hash de um ficheiro de texto
# -----------------------------------------------------------
...
def menu():
    ...
    while True:
        ...
        # ---------------------------------------------------
        # Opção 4 - Verificar autenticidade
        # ---------------------------------------------------
        elif opcao == "4":
